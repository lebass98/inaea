...
const InfoCenterView: React.FC = () => {
  ...
  const infoCenterDetail: InfoCenterDetail = {
    id: parseInt(id || '1'),
            ...
            <div className="bbs-view-detail">
              <div className="bbs-view-header">
                ...
                <div className="bbs-veiw-title-section">
                  <h2>{infoCenterDetail.title}</h2>
                </div>
                <div className="bbs-veiw-meta">
                  <div className="meta-item">
                    <span className="meta-label">조회수</span>
                    <span className="meta-value">{infoCenterDetail.views}</span>
                  </div>
                  <div className="meta-item">
                    <span className="meta-label">등록일시</span>
                    <span className="meta-value">{infoCenterDetail.date}</span>
                  </div>
                </div>
              </div>

              {/* 첨부파일 */}
              {infoCenterDetail.hasAttachment && (
                <div className="attachments-section">
                  <ul className="attachment-list">
                    {infoCenterDetail.attachments.map((file, index) => (
                      <li>
              ...
              <div className="bbs-veiw-content-editor">
                <div dangerouslySetInnerHTML={{ __html: infoCenterDetail.content }} />
              </div>
